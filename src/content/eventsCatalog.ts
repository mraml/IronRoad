...
export const EVENT_CATALOG: Record<string, RuntimeEvent> = {
    ...
    choices: [
      {
        ...
        outcomeText:
          "The crew falls in. Hatches clang shut like punctuation. The column starts moving before anyone has time to change their mind.",
      ...
      },
      {
        ...
        role: "gunner",
        dialogueLine:
          "Request smoke on the ridge at grid 441 before we commit, sir. Blind approach otherwise.",
        outcomeText:
          "He checks the map. Nods. The smoke is called in. You mount up two minutes later, the ridge already turning white.",
      ...
      },
      {
        ...
        flavorOnly: true,
        outcomeText:
          "You mount up. Some things don't need words. The engine turns over and the rest is motion.",
        effects: [],
      },
    ],
  },
    ...
    choices: [
      {
        ...
        outcomeText:
          "Direct is dangerous but it's also decisive. The hull takes paint off the treeline and breaks into the open. The crew knows what to do.",
      ...
      },
      {
        ...
        role: "driver",
        dialogueLine:
          "There's a drainage ditch on the left side. Twenty minutes and I can bring us in behind their gun position.",
        outcomeText:
          "He checks the watch against the map and gives you the twenty. The ditch is tight but the angle is everything you hoped.",
    ...
    choices: [
      {
        ...
        role: "gunner",
        dialogueLine:
          "Hull-down position on that ridge gives us three hundred meter sight lines. We'll see them before they see our main gun.",
        outcomeText:
          "The ridge is everything the gunner said. You wait in the dirt and silence until the first contact. The gun is ready before the order.",
      ...
      },
      {
        ...
        role: "commander",
        dialogueLine:
          "If they punch through the left, what's our fallback grid? I need a route that isn't the road.",
        outcomeText:
          "Morales marks two alternatives on the map. The information is worth more than the minute it cost.",
      ...
      },
      {
        ...
        flavorOnly: true,
        outcomeText:
          "Simple words. The crew hears them and knows what they mean. They move to position without being told.",
        effects: [],
      },
    ],
  },
    ...
    choices: [
      {
        ...
        role: "driver",
        dialogueLine:
          "Shortest route, full speed. We get there before they do or this whole thing falls apart.",
        outcomeText:
          "The driver takes it seriously. Every gear change is a decision, every second saved is a meter of road blocked before they arrive.",
      ...
      },
      {
        ...
        role: "commander",
        dialogueLine:
          "They have a secondary exit through the village on the north track. We cut both and they're boxed.",
      ...
      },
      {
        ...
        flavorOnly: true,
        outcomeText:
          "The tank is in gear before the briefing ends. Connelly lets it happen. That's the right answer.",
        effects: [],
      },
    ],
  },
  gen_travel_fork: {
    ...
    kind: "travel",
    atmosphere:
      "The road is wrong in both directions. It's just a question of which wrong you can live with.",
    narrative:
    ...
    quote:
      '{drv}: "That village gives me bad feelings, Sarge. Every window up there is a decision somebody already made."',
    choices: [
      {
        id: "village",
        ...
        outcomeText:
          "You punch through. Dust lifts. Windows watch like empty eyes. Something moves in the second floor of the church. You don't stop to find out what.",
        effects: [
      ...
      },
      {
        ...
        outcomeText:
          "The engine labors in low gear. Branches rasp the hull like fingernails. Nothing fires. The driver breathes again two hundred meters in.",
      ...
      },
      {
        ...
        outcomeText:
          "Two minutes of patience. The village checks clear. You take it clean, engine still warm, nobody's hands shaking yet.",
        effects: [
    ...
    choices: [
      {
        ...
        outcomeText:
          "The words are ordinary. That's what makes them hurt. The loader finishes, folds the paper along its existing creases, and hands it back without a word.",
      ...
      },
      {
        ...
        outcomeText:
          "Silence becomes its own answer. The envelope sits in a breast pocket for the rest of the day, present without being opened. That's a kind of decision too.",
        effects: [{ op: "mod_all_constitution", delta: 2 }],
      },
      {
        id: "asst_delivers",
        ...
        outcomeText:
          "It was the loader's. He doesn't say anything. He folds it very carefully and tucks it somewhere the others can't see. Nobody asks. That's the crew working correctly.",
        effects: [
  ...
  gen_rest_coffee: {
    ...
    kind: "rest",
    atmosphere:
      "The hull is still warm from the last move. The air smells like spent powder and, improbably, coffee.",
    narrative:
  ...
  gen_supply_risk: {
    ...
    kind: "supply",
    atmosphere:
      "A supply point that shouldn't exist anymore is somehow still operational. The man running it looks like he stopped sleeping two days ago.",
    narrative:
    ...
    preChoiceNpc: {
      speaker: "Corporal Haas",
      line: "Take it and go. Don't sign anything. We're not supposed to be here.",
    },
    choices: [
      {
        id: "meds",
  ...
  gen_combat_panther: {
    ...
    stakes: "elevated",
    stakesNote:
      "Panther on bad ground. AP flank vs smoke vs break contact — Gunner and Commander will disagree.",
    tierFlavor: {
    ...
    choices: [
      ...
      },
      {
        ...
        modifierBonus: 0,
        outcomeText:
          "You back off through a farmyard. The Panther doesn't follow. You don't ask why.",
        effects: [
          { op: "mod_tank_health", delta: -8 },
    ...
    choices: [
      {
        ...
        effects: [{ op: "damage_random_component" }, { op: "mod_all_constitution", delta: -5 }],
      },
      {
        id: "back_up",
      ...
      },
      {
        ...
        effects: [
          ...
          { op: "mod_resource", key: "medkits", delta: -1 },
          {
            op: "add_scar",
            role: "loader",
            text: "treated shrapnel wound, left shoulder",
            rolePenalty: 1,
          },
        ],
      },
  ...
  anchor_bulge: {
    ...
    choices: [
      ...
      },
      {
        ...
        modifierBonus: -1,
        outcomeText:
          "Rounds walk the white ground. Something stops moving. Something else keeps moving.",
        effects: [
          { op: "spend_ammo", ammo: "HE", amount: 3 },
          { op: "mod_tank_health", delta: -6 },
      ...
      },
      {
        ...
        modifierBonus: 1,
        outcomeText:
          "The junction falls. The crew doesn't. Sometimes that's the only math that counts.",
        effects: [
          { op: "mod_all_constitution", delta: -8 },
          { op: "add_salvage", amount: 2 },
          { op: "seed_flag", flag: "bulge_held_junction" },
    ...
    choices: [
      {
        ...
        role: "driver",
        outcomeText:
          "Water becomes sky becomes mud. You emerge on the wrong side of history — exactly where you're supposed to be.",
  ...
  anchor_paris_skirt: {
    ...
    choices: [
      ...
      },
      {
        ...
        role: "driver",
        outcomeText:
          "More road. Less weight. The detour smells like hay and something that used to be summer.",
        effects: [
      ...
      },
      {
        ...
        role: "loader",
        outcomeText:
          "He buys bread he can't afford with money that won't be worth anything soon. The bread is perfect.",
        effects: [
  ...
  anchor_siegfried: {
    ...
    choices: [
      ...
      },
      {
        ...
        modifierBonus: 1,
        outcomeText:
          "Half a mile east, where engineers apparently took a lunch break. You note it. You don't report it.",
        effects: [
          { op: "mod_constitution", role: "driver", delta: 6 },
          { op: "add_salvage", amount: 1 },
        ],
  ...
  anchor_push_germany: {
    ...
    choices: [
      ...
      },
      {
        ...
        role: "loader",
        outcomeText:
          "The man lives or he doesn't. You don't stay to find out. The tank doesn't wait.",
        effects: [
          { op: "mod_constitution", role: "loader", delta: 8 },
          { op: "mod_hp", role: "loader", delta: -4 },
          {
            op: "journal",
            text: "Stopped for a wounded man in the push into Germany.",
            kind: "moment",
          },
        ],
      },
  ...
  foot_woods: {
    ...
    choices: [
      ...
      },
      {
        ...
        effects: [{ op: "mod_constitution", role: "loader", delta: -3 }],
      },
    ],
  },
  foot_lines: {
    ...
    choices: [
      ...
      },
      {
        ...
        role: "commander",
        outcomeText:
          "The driver slows just enough. Two words and a hand gesture. Better than nothing.",
        effects: [
          { op: "mod_all_constitution", delta: 3 },
  ...
  foot_gate: {
    ...
    narrative: "Friendly lines smell like diesel and hot food. A sergeant counts you like cargo.",
    useDice: true,
    choices: [
      {
        id: "talk",
...
Object.assign(EVENT_CATALOG, {
  social_cards: {
    ...
    kind: "rest",
    atmosphere:
      "A lantern or a candle or a flashlight someone left running. Some light. Enough light. Cards on a ration crate and the sound of breathing and shuffling.",
    narrative:
    ...
    choices: [
      {
        ...
        outcomeText:
          "Nobody wins. Nobody loses. The game holds something together until dawn — not victory, not rest, just the specific continuity of people who know each other well enough to cheat and not mind.",
        effects: [
      ...
      },
      {
        ...
        outcomeText:
          "The noise is good noise. The laughter is real laughter. From the edge of it you can see the crew as something other than a crew — as people, briefly — and that's a different kind of quiet than the other kind.",
      ...
      },
      {
        ...
        outcomeText:
          "The hand is ugly and wonderful and nobody has money worth anything in this country anyway but they play it like it matters. The pot goes to the loader. The driver doesn't care. It wasn't about the money.",
        effects: [
          { op: "mod_constitution", role: "driver", delta: 6 },
          { op: "mod_all_constitution", delta: 6 },
        ],
  ...
  social_letters: {
    ...
    kind: "rest",
    atmosphere:
      "Mail arrives the way news arrives in wartime — delayed, rerouted, arriving in the wrong order, still the most important thing that happens today.",
    narrative:
    ...
    quote:
      '{drv}: "Read it slow. Some letters you only get once. Even if they come more than once, you only get them once."',
    choices: [
      {
        id: "write_back",
        ...
        outcomeText:
          "The words come hard and come right in that order. There's not much space on the paper but the space is enough. That's the best you can do. It arrives three weeks later and is the best thing that happens to someone that week.",
        effects: [
      ...
      },
      {
        ...
        outcomeText:
          "Later keeps getting later. The letter travels folded in a breast pocket through three more engagements. It's read eventually. Just not today.",
        effects: [{ op: "mod_all_constitution", delta: 3 }],
      },
      {
        id: "loader_reads",
        ...
        outcomeText:
          "It's ordinary. A dog is sick but better. A pipe is leaking. A friend got married. Something about weather. Everyone is quiet after, in the specific way of people who are thinking about dogs and weather and leaking pipes and everything that means.",
        effects: [
          { op: "mod_constitution", role: "loader", delta: 10 },
          { op: "mod_all_constitution", delta: 7 },
          {
            op: "journal",
            text: "Loader read his letter aloud. A dog. A leaky pipe. A wedding.",
            kind: "moment",
          },
        ],
      },
  ...
  social_chaplain: {
    ...
    preChoiceNpc: {
      speaker: "Chaplain",
      line: "I'm not here for anything in particular. Just making the rounds.",
    },
    choices: [
      {
        id: "talk",
        ...
        outcomeText:
          "Half of what you say surprises you. The other half surprises him but he doesn't show it. He listens to all of it. When you're done he doesn't offer answers. He offers the specific silence of someone who has heard this before and knows it doesn't resolve.",
        npcReply:
          "\"Most of what you're carrying is going to stay with you. That doesn't mean it stays the same weight.\"",
        effects: [
      ...
      },
      {
        ...
        outcomeText:
          "He says that's fine. He means it. He sits for twenty minutes and asks nothing. The silence isn't empty — it's occupied by everything neither of you needs to name aloud. That's the part that matters.",
        npcReply:
          "When he leaves he puts a hand briefly on the hull of the tank. Not the crew. The tank. Like it has something to carry too.",
      ...
      },
      {
        ...
        outcomeText:
          "The chaplain finds him anyway. Sits on the front hull beside him in the dark. Doesn't mention God once. Asks the gunner where he's from, what the winters are like there, whether he ever learned to cook. The gunner answers all of it.",
        npcReply:
          '"Good conversation," the chaplain says, getting up. "Thank you for the company." He walks back to his jeep. The gunner sits for a while longer before going inside.',
        effects: [
  ...
  social_rumor: {
    ...
    kind: "rest",
    atmosphere:
      "The kind of afternoon that has nothing to do but wait. Which is when the rumors move fastest.",
    narrative:
    ...
    choices: [
      {
        ...
        outcomeText:
          "The argument is stupid and brief and self-aware enough that everyone knows it. That's fine. Everyone feels marginally better for having had it. The specific relief of caring about something that doesn't matter.",
      ...
      },
      {
        ...
        outcomeText:
          "Most of it's garbage arranged to sound like intelligence. One detail sticks — not the dramatic one, but a small specific thing about road conditions near the secondary objective. The commander writes it down.",
        effects: [
          { op: "add_salvage", amount: 1 },
          { op: "mod_constitution", role: "commander", delta: 4 },
        ],
      },
      {
        ...
        outcomeText:
          "The rumor is specific enough to be interesting and vague enough to be improvable. The crew argues about which half is true. The driver maintains he heard it directly from a signals officer. Nobody believes him. That's exactly how it should work.",
        effects: [
          { op: "mod_constitution", role: "driver", delta: 8 },
          { op: "mod_all_constitution", delta: 5 },
        ],
...
Object.assign(EVENT_CATALOG, {
  ...
  foot_farm: {
    ...
    atmosphere:
      "The smell of hay and livestock in a working barn. Someone here is still living their life in spite of everything.",
    narrative:
      "A barn door opens a crack. A woman older than the war gestures with one hand — come in, eat, be quiet. She doesn't smile. She doesn't have to.",
    ...
    choices: [
      {
        ...
        outcomeText:
          "Bread tastes like guilt and gratitude at the same time. She refills the loader's bowl without looking at him. That's the closest thing to welcome the barn has.",
        npcReply:
          "She says nothing else. When you leave she closes the barn door and latches it. She'll be fine. She's been fine before.",
        effects: [
          { op: "mod_resource", key: "foodDays", delta: 1 },
          { op: "mod_constitution", role: "loader", delta: 6 },
        ],
      },
      {
        ...
        outcomeText:
          "Her face doesn't change. That's the hardest part — there's no disappointment or relief, just the face of someone who has learned not to expect anything in particular from men with guns.",
      ...
      },
      {
        ...
        outcomeText:
          "He eats last. He eats cold. He doesn't say anything about it and neither does anyone else because everyone knows it was right.",
        npcReply:
          "When the gunner comes in last she hands him bread without ceremony and goes back to whatever she was doing before the war interrupted.",
        effects: [
          { op: "mod_resource", key: "foodDays", delta: 1 },
          { op: "mod_constitution", role: "gunner", delta: -4 },
          { op: "mod_all_constitution", delta: 4 },
  ...
  foot_checkpoint: {
    ...
    atmosphere:
      "A rope across the road and two MPs who look like they've been here since Tuesday and Tuesday was last week.",
    narrative:
      "MPs wave you toward a checkpoint. They don't ask questions they don't want answered but they do ask questions. The taller one has a clipboard. The other one watches the treeline like it owes him money.",
    preChoiceNpc: {
      speaker: "MP, Taller One",
      line: "State your unit, destination, and what happened to your vehicle, in that order.",
    },
    choices: [
      {
        id: "papers",
        ...
        role: "commander",
        dialogueLine:
          "Dog tags, serial numbers. Vehicle was lost to enemy action. We're moving to friendly lines.",
        outcomeText:
          "Rubber stamps and tired eyes. You become paperwork again. The MP writes something down and waves you through. You are official. You almost feel human.",
        npcReply:
          "He hands back the tags. \"Stay on this road. Second right. Don't stop for anything that isn't wearing a helmet.\"",
        effects: [{ op: "mod_all_constitution", delta: 3 }],
      },
      {
        id: "driver_talks",
        ...
        role: "driver",
        dialogueLine:
          "Hey, Corporal — we're 3rd Armored, tank went down at the river crossing, trying to link up with the column. You probably heard about it. Whole mess.",
        outcomeText:
          "The MP's pen pauses. He hasn't heard about it specifically. But he's heard about enough things today that this sounds plausible enough. He waves them through.",
        npcReply:
          "\"Stay on the road. Don't make me look for you.\" He watches you go with the expression of a man who knows he'll never find out if that was true.",
        effects: [
          { op: "mod_constitution", role: "driver", delta: 6 },
          { op: "mod_all_constitution", delta: 2 },
        ],
      },
      {
        ...
        outcomeText:
          "The MPs are tired and there's a column backing up behind you. They wave you through without checking bags. The salvage kit rides in the loader's jacket. It stays.",
  ...
  foot_ditch: {
    ...
    narrative:
      "A drainage ditch smells like fuel and rain. You follow it because maps lie less than roads.",
    choices: [
      {
        id: "follow",
  ...
  foot_dog: {
    ...
    atmosphere:
      "Mid-column, the sound of boots on a road that's been used too much. And something else. Lighter. Four feet.",
    narrative:
      "A dog falls in beside the column for a mile. It's not a thin dog — somebody's been feeding it. Nobody names it. Nobody admits they're glad it's there. It just walks beside them like it has somewhere to be and this is the right direction.",
    choices: [
      {
        id: "share",
        ...
        outcomeText:
          "The dog takes it politely. It walks another quarter mile and then peels off into the ditch without ceremony. That's its job. It had somewhere else to be after all.",
        effects: [
          { op: "mod_resource", key: "foodDays", delta: -1 },
          { op: "mod_all_constitution", delta: 4 },
        ],
      },
      {
        ...
        outcomeText:
          "It goes. Eventually. The driver doesn't feel good about it. That's probably the right response.",
        effects: [
          { op: "mod_constitution", role: "driver", delta: -5 },
          { op: "mod_all_constitution", delta: 1 },
        ],
      },
      {
        ...
        outcomeText:
          "It follows for two miles and then makes its own decision about its next destination. Some company asks for nothing and offers everything. That's the best kind.",
        effects: [{ op: "mod_all_constitution", delta: 6 }],
      },
    ],
  } satisfies import("../engine/types").RuntimeEvent,
    ...
    choices: [
      ...
      },
      {
        ...
        effects: [
          ...
          {
            op: "journal",
            text: "Asst driver bluffed a King Tiger's crew with false radio orders.",
            kind: "moment",
          },
        ],
      },
  ...
  gen_travel_mine: {
    ...
    narrative:
      "A mine marker tilts wrong — too new, too clean. Someone moved the wire. There's a fresh scrape in the dirt where the road narrows between two drainage culverts. The driver stops before being asked.",
    useDice: true,
    choices: [
      {
        id: "probe",
        ...
        outcomeText:
          "The world holds its breath for seventeen seconds. The track finds dirt. The driver breathes again in a way that sounds like it cost him something.",
      ...
      },
      {
        ...
        outcomeText:
          "He finds it — pressure plate, shifted laterally, not buried deep enough. He marks it, backs away, reports. The detour costs twenty minutes. The alternative costs more.",
        effects: [
          { op: "mod_constitution", role: "asst_driver", delta: -10 },
          { op: "mod_all_constitution", delta: 3 },
        ],
      },
      {
        ...
        modifierBonus: -1,
        dialogueLine:
          "Don't trust it. Go left through the field, rejoin the road past the culvert.",
        outcomeText:
          "The field is soft. The tank bogs briefly and the driver earns his pay getting through it. Cleaner than the alternative.",
        effects: [
          { op: "mod_tank_health", delta: -5 },
          { op: "mod_all_constitution", delta: 2 },
        ],
  ...
  gen_travel_bridge_down: {
    ...
    narrative:
      "The bridge is gone — just ribs of steel and a cold joke in the water below. Someone blew it recently; the ends still smoke where the charges went.",
    choices: [
      {
        id: "ford",
        ...
        outcomeText:
          "Cold water climbs the hull like a second crew. The engine complains the whole way. You reach the far bank with everything working and no dignity left.",
        effects: [
          { op: "mod_tank_health", delta: -4 },
          { op: "mod_resource", key: "waterCanteens", delta: -1 },
        ],
      },
      {
        ...
        outcomeText:
          "Two hours. Longer than you wanted, shorter than the alternative if the ford had failed. The crossing is clean and costs nothing but time.",
        effects: [
          { op: "mod_all_constitution", delta: -3 },
          { op: "mod_all_constitution", delta: 4 },
        ],
      },
      {
        ...
        outcomeText:
          "The loader comes back wet to the knees with actual useful information. The crossing saves the hull three percent hull damage and finds a supply cache someone left in the reeds.",
        effects: [
  ...
  gen_human_watch: {
    ...
    kind: "human_moment",
    atmosphere:
      "The village is too quiet for a village. The only things moving are the wrong height to be soldiers.",
    narrative:
      "Two kids watch the tank pass like it's weather. One waves. The other doesn't blink. They're standing on a wall that used to be the front of something.",
    ...
    choices: [
      {
        ...
        outcomeText:
          "The waving kid smiles. The other still doesn't blink. The loader holds the wave until the tank clears the corner.",
        npcReply:
          "The waving one waves twice more and runs inside. The still one just watches until you're gone.",
        effects: [{ op: "mod_constitution", role: "loader", delta: 5 }],
      },
      {
        id: "stop_explain",
        ...
        outcomeText:
          "One of them says a word in their language that might mean thank you or might mean something else entirely. He saves it anyway.",
        ...
        effects: [
          ...
          {
            op: "journal",
            text: "Two kids watching the tank. One waved. One didn't.",
            kind: "moment",
          },
        ],
      },
      {
        ...
        outcomeText:
          "The kids shrink in the mirror. The driver turns the mirror down. Some things are easier not to watch.",
        effects: [{ op: "mod_constitution", role: "driver", delta: -5 }],
      },
    ],
  } satisfies import("../engine/types").RuntimeEvent,
  gen_supply_black_market: {
    ...
    atmosphere:
      "This man has been in three different theaters. None of them officially. He has a look that says he'll outlast the war, the army, and possibly the country.",
    narrative:
      "A sergeant with no visible unit affiliation and an improbable number of crates sits behind a jeep in a ruined farmyard. He sells chocolate, ammunition, and the kind of information that has a short shelf life.",
    preChoiceNpc: {
      speaker: "Sgt. Unknown",
      line: "I don't know your names and I don't want to. What do you need and what do you have?",
    },
    choices: [
      {
        id: "buy_food",
        ...
        outcomeText:
          "You overpay in currency the army doesn't recognize. The food is real. The sergeant has heard the story before but listens anyway.",
        npcReply:
          "Good enough. Tell your division the crossroads at Pont-Ste-Marie is clear on the east side. That's free.",
        effects: [
          { op: "spend_salvage", amount: 2 },
      ...
      },
      {
        ...
        outcomeText:
          "The sergeant's eyes light up with the particular joy of a man who trades in useful things. Gunner walks back with AP rounds and no regrets at all.",
        npcReply:
          "Next time you're through this sector, ask for me by the wrong name. I'll know who you mean.",
        effects: [
          { op: "mod_constitution", role: "gunner", delta: -4 },
      ...
      },
      {
        ...
        role: "loader",
        dialogueLine:
          "That price is what you tell guys who don't know the going rate. We know the going rate.",
        outcomeText:
          "The sergeant respects it the way men who negotiate for a living always respect someone who won't fold. You get more than you paid for.",
    ...
    choices: [
      {
        ...
        outcomeText:
          "Sometimes rest is not doing anything louder than necessary. The crew finds the frequency of their own breathing and stays there for twenty minutes. It helps more than anyone says.",
      ...
      },
      {
        ...
        outcomeText:
          "Nobody asks. The food is real. There's enough for everyone if nobody takes more than their share, which everyone knows without being told.",
        effects: [
          { op: "mod_resource", key: "foodDays", delta: 1 },
          { op: "mod_all_constitution", delta: 7 },
          { op: "mod_constitution", role: "loader", delta: 5 },
      ...
      },
      {
        ...
        outcomeText:
          "The punchline doesn't land at all. Three men laugh until it does. Laughter is a sound that doesn't belong here and that's exactly why you need it.",
        effects: [
          { op: "mod_constitution", role: "asst_driver", delta: 6 },
          { op: "mod_all_constitution", delta: 8 },
        ],
  ...
  gen_infantry_cellar: {
    ...
    narrative:
      "Cellar doors slam. Muzzles in the dark. Someone screams orders in two languages at once.",
    useDice: true,
  ...
  gen_officer_roadblock: {
    ...
    atmosphere:
      "There are two kinds of officers in a war. The kind who've been to the front and the kind blocking the road.",
    narrative:
      "A staff car blocks the road with its bumper precisely in the center of it. A colonel with clean boots stands beside it and checks his watch in a way that suggests time is being wasted — specifically, yours.",
    preChoiceNpc: {
      speaker: "Col. Something",
      line: "You. Tank commander. I need your vehicle's fuel capacity and current load. Division is short on estimates.",
    },
    choices: [
      {
        id: "comply",
        ...
        role: "commander",
        dialogueLine:
          "Sir. Fuel capacity is rated 170 gallons. Current load is classified until your aide produces the right form. Sir.",
        outcomeText:
          "You lose an hour and some patience but keep your orders clean. The colonel writes something on a clipboard. He does not thank you.",
      ...
      },
      {
        id: "driver_bypass",
        label:
          "Driver eases through the ditch around the staff car — technically not disobeying orders.",
        role: "driver",
        dialogueLine: "Sorry, Colonel, brakes are — we're moving. Very sorry.",
        outcomeText:
          "The colonel's aide shouts something. The engine is louder than his opinion about it.",
        npcReply:
          "The colonel's voice carries into the distance. He has strong feelings. The tank has a transmission and wins.",
        effects: [
          { op: "mod_constitution", role: "driver", delta: 6 },
          { op: "mod_tank_health", delta: -2 },
        ],
      },
      {
        ...
        outcomeText:
          "The colonel looks at the gun barrel. The gun barrel looks at the staff car. The staff car moves. Nobody says a word about it. Nobody ever will.",
        npcReply:
          "The colonel gets in his car facing away from you. He drives off at exactly the speed of a man pretending nothing happened.",
        effects: [
          { op: "mod_constitution", role: "gunner", delta: 4 },
          { op: "mod_all_constitution", delta: 5 },
        ],
  ...
  gen_radio_squeal: {
    ...
    narrative:
      "The radio squeals with a voice that isn't yours and coordinates that don't match the map. The voice is calm. That's the wrong kind of calm.",
    preChoiceNpc: {
      speaker: "Unknown station",
      line: "Requesting any station on this net — we have a fire mission and nobody answering. Over.",
    },
    choices: [
      {
        id: "ignore",
        ...
        outcomeText:
          "Silence returns. So does the doubt about whether that was the right call. It probably was. It might not have been.",
      ...
      },
      {
        ...
        outcomeText:
          "Wrong frequency, friendly unit, very confused. Right instinct. Someone else's fire mission, someone else's problem, but at least you know.",
      ...
      },
      {
        ...
        outcomeText:
          "It's a field artillery battery three klicks north, radio operator new and lost. You help them. They give you a reference grid for the next twenty-four hours. That's worth more than it sounds.",
  ...
  gen_loader_shell_stuck: {
    ...
    narrative:
      "The breech ring eats a round. The gunner curses like prayer. The tank is a metal throat with something stuck in it.",
    choices: [
      {
        id: "kick",
        ...
        effects: [
          { op: "mod_constitution", role: "loader", delta: -6 },
          { op: "set_component", component: "main_gun", status: "damaged" },
        ],
      },
      {
        ...
        role: "commander",
        outcomeText:
          "Five minutes outside the tank. Cold air, clearer head. The breach clears clean.",
        effects: [
          { op: "mod_all_constitution", delta: -3 },
          { op: "mod_constitution", role: "loader", delta: 4 },
        ],
  ...
  gen_asst_periscope: {
    ...
    narrative:
      "The assistant driver's periscope fogs and won't clear. The world shrinks to a grey coin.",
    choices: [
      {
        id: "wipe",
...
Object.assign(EVENT_CATALOG, {
    ...
    choices: [
      {
        ...
        modifierBonus: 0,
        outcomeText:
          "Water climbs the hull to the sponson. The engine complains. You make the far bank before it stops complaining.",
        effects: [
          { op: "mod_tank_health", delta: -5 },
          { op: "add_salvage", amount: 3 },
      ...
      },
      {
        ...
        modifierBonus: 1,
        outcomeText:
          "An hour costs nothing but time. The engineers wave you through. You cross clean.",
        effects: [
          { op: "mod_all_constitution", delta: -3 },
          { op: "add_salvage", amount: 2 },
          { op: "seed_flag", flag: "seine_pursuit" },
      ...
      },
      {
        id: "salvage_crossing",
        label:
          "Loader spots abandoned German supply wagons on the near bank — strip them before crossing.",
        role: "loader",
        modifierBonus: -1,
        outcomeText:
          "The wagons give up their ammunition without ceremony. You cross heavier and later than planned.",
        effects: [
          { op: "mod_resource", key: "foodDays", delta: 2 },
          { op: "add_salvage", amount: 5 },
          { op: "seed_flag", flag: "seine_pursuit" },
  ...
  anchor_cologne: {
    ...
    quote:
      '{gnr}: "Six hundred meters. Rubble everywhere. He can angle and we can\'t stop him if he does."',
    useDice: true,
    enemy: { idealAmmo: "AP", combatMod: -1, label: "Panther" },
    choices: [
      {
        ...
        modifierBonus: -1,
        outcomeText:
          "The round flies in a cathedral that used to have a roof. The Panther doesn't answer.",
        effects: [
          { op: "spend_ammo", ammo: "AP", amount: 3 },
          { op: "damage_random_component" },
          { op: "add_salvage", amount: 5 },
      ...
      },
      {
        id: "cmd_reposition",
        label:
          "Commander calls for infantry coordination — smoke, then reposition for a rear shot.",
        role: "commander",
        modifierBonus: 1,
    ...
    choices: [
      {
        ...
        role: "commander",
        outcomeText:
          "The silence after shooting stops isn't peaceful. It's just different. The crew sits with it. That's enough.",
        effects: [
      ...
      },
      {
        ...
        role: "asst_driver",
        outcomeText:
          "Someone has a bottle they've been saving since Normandy. It tastes like regret and relief and something that doesn't have a name.",
        effects: [
          { op: "mod_all_constitution", delta: 12 },
    ...
    choices: [
      {
        ...
        modifierBonus: -1,
        outcomeText:
          "The bridge shakes. Men are dying on both ends of it. You reach the far side with your momentum and some of your crew.",
        effects: [
          { op: "spend_ammo", ammo: "HE", amount: 3 },
      ...
      },
      {
        ...
        modifierBonus: 0,
        outcomeText:
          "The WP screen turns them blind. Infantry floods the near side. You cross in their wake.",
        effects: [
      ...
      },
      {
        ...
        modifierBonus: 1,
        outcomeText:
          "The approach angle you find changes the whole equation. They can't respond to what they can't see.",
        effects: [
          { op: "spend_ammo", ammo: "HE", amount: 2 },
          { op: "mod_constitution", role: "asst_driver", delta: 10 },
          { op: "add_salvage", amount: 5 },
  ...
  elite_tiger_wallendorf: {
    ...
    quote:
      '{gnr}: "At this range, if we miss once, we don\'t get another. That thing will open us like a can."',
    useDice: true,
    ...
    choices: [
      {
        ...
        modifierBonus: 1,
        outcomeText:
          "You back down the lane fast enough that something ceramic breaks in the hull. The Tiger's turret is still moving when you put AP through the side plate.",
        effects: [
          { op: "spend_ammo", ammo: "AP", amount: 3 },
          { op: "damage_random_component" },
          { op: "add_salvage", amount: 6 },
      ...
      },
      {
        ...
        modifierBonus: 2,
        outcomeText:
          "Pride is a luxury. The call goes up to artillery. An hour later, Wallendorf has a crater problem. You have ammunition.",
        effects: [
          { op: "mod_all_constitution", delta: -8 },
          { op: "mod_resource", key: "foodDays", delta: 1 },
          { op: "add_salvage", amount: 2 },
          {
            op: "journal",
            text: "Called in the Tiger at Wallendorf. Someone else got the kill.",
            kind: "moment",
          },
        ],
      },
      {
        ...
        modifierBonus: 0,
        outcomeText:
          "Patience is a kind of ammunition. The Tiger rounds the corner into your shot. The barn is kindling but the Tiger is stopped.",
        effects: [
          { op: "spend_ammo", ammo: "AP", amount: 2 },
      ...
      },
      {
        ...
        modifierBonus: -1,
        outcomeText:
          "The wall comes down in three shells. The Tiger is trapped under rubble, still alive, still trying to traverse. You put AP through the roof hatch.",
        effects: [
          { op: "spend_ammo", ammo: "HE", amount: 3 },
...
Object.assign(EVENT_CATALOG, {
    ...
    choices: [
      {
        ...
        role: "commander",
        outcomeText:
          "Morning is less kind than the bottle but the crew gives him space. He's embarrassed in the useful way.",
        effects: [
          { op: "mod_all_constitution", delta: 8 },
          { op: "mod_constitution", role: "driver", delta: -5 },
        ],
      },
      {
        ...
        role: "loader",
        outcomeText:
          "Two men and a bottle and the war at arm's length for one evening. Not safe. Not sustainable. Exactly right.",
        effects: [
          { op: "mod_all_constitution", delta: 12 },
          { op: "mod_constitution", role: "loader", delta: -3 },
          { op: "mod_constitution", role: "driver", delta: 5 },
      ...
      },
      {
        ...
        role: "asst_driver",
        outcomeText:
          "The water helps less than the company. He's operational by midnight. He owes the asst driver something unnamed.",
        effects: [
    ...
    choices: [
      {
        ...
        role: "loader",
        outcomeText:
          "The thing rides in his breast pocket. He doesn't explain it. Nobody asks. That's how crew works.",
        effects: [
          { op: "mod_constitution", role: "loader", delta: 12 },
          {
            op: "journal",
            text: "Something found in a liberated house rides with the crew.",
            kind: "moment",
          },
        ],
      },
      {
        ...
        role: "commander",
        outcomeText:
          "It stays on the shelf exactly where he found it. That sits better than he expected.",
        effects: [
          { op: "mod_all_constitution", delta: 5 },
      ...
      },
      {
        ...
        role: "asst_driver",
        outcomeText:
          "The photograph goes from hand to hand. Nobody speaks. It comes back to him and he puts it in his pocket anyway.",
        effects: [
          { op: "mod_all_constitution", delta: 9 },
          { op: "mod_constitution", role: "loader", delta: 6 },
          {
            op: "journal",
            text: "A photograph from a liberated house. Everyone held it once.",
            kind: "moment",
          },
        ],
      },
    ...
    choices: [
      {
        ...
        role: "commander",
        outcomeText:
          "Thirty seconds of observation and the gunner says it. The name sticks before the replacement can object. Welcome.",
        effects: [
          { op: "mod_all_constitution", delta: 8 },
          {
            op: "journal",
            text: "A replacement arrived. The crew named him before he could.",
            kind: "moment",
          },
        ],
      },
      {
        ...
        role: "loader",
        outcomeText:
          "He looks surprised. He gives them a name from back home. It fits well enough. That's rare.",
        effects: [
          { op: "mod_all_constitution", delta: 10 },
      ...
      },
      {
        id: "give_name",
        label:
          "Asst Driver already has the name ready — he was watching from when the truck stopped.",
        role: "asst_driver",
        outcomeText:
          "The asst driver points at the replacement's face: 'That's your name.' Nobody argues. The replacement nods like a man accepting a verdict.",
        effects: [
          { op: "mod_all_constitution", delta: 7 },
          { op: "mod_constitution", role: "asst_driver", delta: 6 },
          {
            op: "journal",
            text: "A replacement arrived. Asst Driver had the name waiting.",
            kind: "moment",
          },
        ],
      },
    ...
    choices: [
      {
        ...
        role: "commander",
        outcomeText:
          "He rides on the deck when the hatch is open. He's quiet during contact. He has opinions about rations. The crew votes him in unanimously and doesn't mention it.",
        effects: [
          { op: "mod_all_constitution", delta: 15 },
      ...
      },
      {
        ...
        role: "loader",
        outcomeText:
          "He takes what's offered and sits until the column moves. You don't look back. He's still sitting when you turn the corner. You feel it for a while.",
        effects: [
          { op: "mod_all_constitution", delta: 8 },
          { op: "mod_resource", key: "foodDays", delta: -1 },
          {
            op: "journal",
            text: "The dog found the crew again. They fed him and said goodbye.",
            kind: "moment",
          },
        ],
      },
      {
        ...
        role: "asst_driver",
        outcomeText:
          "The dog comes without hesitation. The asst driver looks ridiculous for a moment. Then he just looks happy. That's fine too.",
        effects: [
          { op: "mod_all_constitution", delta: 12 },
          { op: "mod_constitution", role: "asst_driver", delta: 8 },
          {
            op: "journal",
            text: "The dog chose. Asst Driver called him and he came.",
            kind: "moment",
          },
        ],
      },
  ...
  npc_local_woman: {
    ...
    atmosphere:
      "A bombed street with water still running from a broken pipe. And a woman standing beside a doorway holding a pitcher like things are normal.",
    narrative:
      "A civilian woman — French, Belgian, somewhere in the middle of the geography of this war — stands at the edge of a courtyard and offers water from a clay pitcher. She doesn't speak English. She doesn't need to. The gesture is clear.\n\nShe's been here through all of it. Before you, during, and probably after.",
    ...
    choices: [
      {
        ...
        outcomeText:
          "The water is cold and tastes like the town used to. She watches the crew drink and something in her face is not quite a smile but is close enough to matter.",
        npcReply:
          "She refills the pitcher from somewhere and goes back inside. She didn't have to do that. She did it anyway.",
        effects: [
          { op: "mod_resource", key: "waterCanteens", delta: 1 },
          { op: "mod_all_constitution", delta: 4 },
        ],
      },
      {
        ...
        outcomeText:
          "She hesitates, then withdraws into her doorway. The commander doesn't know if he made the right call. He made a call.",
      ...
      },
      {
        ...
        outcomeText:
          "She points east. Three fingers. She's been watching. She's been keeping count. The gunner marks the direction on his mental map.",
        npcReply:
          "She says something fast in French, then mimes a tank — hands like a low hull — and shakes her head. They're gone. For now.",
        effects: [
          { op: "mod_resource", key: "waterCanteens", delta: 1 },
          { op: "mod_all_constitution", delta: 3 },
          { op: "add_salvage", amount: 1 },
  ...
  npc_local_kids: {
    ...
    kind: "npc_conversation",
    atmosphere:
      "The town is the kind of half-empty that happens when some people left and some people stayed. The ones who stayed have children.",
    narrative:
      "Two kids have materialized at the side of the road — there one moment and not there the previous one. They watch the crew with the total unself-consciousness of children who have seen enough soldiers that soldiers don't frighten them anymore. They might be eight. They might be older. This war ages things.",
    ...
    choices: [
      {
        ...
        flavorOnly: true,
        outcomeText:
          "The crew waves. The kids wave back. The tank keeps moving. It's a small transaction but it's real.",
        effects: [],
      },
      {
        id: "slow_something",
        ...
        outcomeText:
          "The older one says his name. The younger one says something that might be a name or might be a complaint about the older one. The commander repeats the name back. The kid corrects his pronunciation. They're laughing by the time the tank moves again.",
        npcReply:
          "They run alongside for half a block before peeling off. The older one shouts something that sounds like it might be a joke in French.",
        effects: [
          { op: "mod_all_constitution", delta: 5 },
          {
            op: "journal",
            text: "Two kids at the roadside. The older one laughed at my French.",
            kind: "moment",
          },
        ],
      },
      {
        ...
        outcomeText:
          "The chocolate lands in the older kid's hands and both of them look at it like it's something religious. The driver gets back in his seat feeling like a human being, which is rarer than it sounds.",
        npcReply:
          "They're already running away with it before the hatch closes. The younger one waves without looking back.",
        effects: [
          { op: "mod_resource", key: "foodDays", delta: -1 },
          { op: "mod_constitution", role: "driver", delta: 8 },
          { op: "mod_all_constitution", delta: 3 },
  ...
  npc_officer_orders: {
    ...
    kind: "npc_conversation",
    atmosphere:
      "Before an engagement everything is too quiet and too loud at the same time. Then a staff officer rides up.",
    narrative:
      "A staff officer on a horse — actually a horse, in 1944, as if the cavalry hasn't gotten the memo — reins up beside the column before the line of departure. He has orders. He has opinions about them. He has a look that says he didn't sleep and wasn't expecting to.",
    preChoiceNpc: {
      speaker: "Maj. Stafford",
      line: "Listen carefully. Command has revised the axis of advance. You are now the rightmost element. The left flank is infantry. Do not wait for them.",
    },
    choices: [
      {
        id: "yes_sir",
        ...
        role: "commander",
        dialogueLine:
          "Yes sir, understood. Rightmost element, don't wait for infantry. We'll move on your signal.",
        flavorOnly: true,
        outcomeText:
          "The officer nods and wheels the horse. The crew has their orders. Orders are a kind of certainty, even when they aren't.",
        effects: [],
      },
      {
        id: "adjust_approach",
        ...
        role: "commander",
        dialogueLine:
          "Sir, the rightmost approach crosses an exposed ridgeline at grid 447. Request we lead with smoke.",
        outcomeText:
          "The major checks the map. He doesn't say good catch. He says adjust approved, then turns and rides back down the column. That's good catch in officer.",
      ...
      },
      {
        ...
        outcomeText:
          "He looks at the gunner like men of his rank sometimes look at men who ask the right questions. Then he answers it. That's the whole exchange. Worth every second.",
  ...
  npc_replacement_depot: {
    ...
    kind: "npc_conversation",
    atmosphere:
      "Between missions the supply depot is where the war does its paperwork. It smells like diesel and forms in triplicate.",
    narrative:
      "A supply sergeant behind a table of crates has the look of a man who has processed ten thousand requisitions and is profoundly unimpressed by need. He has what you need — probably — in the crates behind him that he's technically not supposed to have.",
    preChoiceNpc: {
      speaker: "S/Sgt. Kowalski",
      line: "Unit, requisition number, and don't tell me you lost the carbon copy.",
    },
    choices: [
      {
        id: "thank_leave",
        ...
        outcomeText:
          "Simple works. You get what's owed, he gets his clipboard back, and nobody argues about the difference. That's a successful transaction in wartime.",
      ...
      },
      {
        ...
        role: "loader",
        dialogueLine:
          "Sergeant — we burned through most of our AP at the bridge. Anything in those crates behind you?",
        outcomeText:
          "He looks at the crates. Looks at you. Looks at the crates. Does some arithmetic the army didn't teach him. Opens one crate. Doesn't say anything about it.",
        npcReply:
          "\"Sign here. And here. And here on the carbon copy you don't have, so I'll just write 'attached'.\"",
        effects: [
          { op: "mod_constitution", role: "loader", delta: 4 },
          { op: "add_salvage", amount: 2 },
        ],
      },
      {
        ...
        outcomeText:
          "He sets the clipboard down. That's not a good sign. What he tells you is operational. What he doesn't tell you is in his face and that's enough.",
        npcReply:
          "\"Heavy losses. Medic tells me at least thirty percent. Don't ask me anything else because I'll say I didn't hear the question.\"",
        effects: [
          { op: "mod_constitution", role: "commander", delta: -4 },
          { op: "mod_all_constitution", delta: -2 },
          {
            op: "journal",
            text: "The 12th Armored took heavy losses ahead of us.",
            kind: "discovery",
          },
        ],
      },
  ...
  npc_other_crew: {
    ...
    kind: "npc_conversation",
    atmosphere:
      "Another tank at rest in a farmyard. Different markings, same mud. Different war, same war.",
    narrative:
      "A crew from a different company — different unit patch, same thousand-yard look — has their tank parked in the shade of a half-standing barn. Their commander is eating something out of a tin and watching the column move past without much interest. Then his eyes catch yours and he nods.",
    preChoiceNpc: {
      speaker: "Other crew commander",
      line: "What unit? We've been trying to get a picture of who's where.",
    },
    choices: [
      {
        id: "trade_rumors",
        ...
        role: "commander",
        dialogueLine:
          "We're 3rd Armored. We came through the river crossing at Pont-Neuf. What are you seeing east of here?",
        outcomeText:
          "He has something you don't and you have something he doesn't. The trade takes five minutes and is worth more than either side's individual share.",
        npcReply:
          '"Stay off the main road past the factory. They had a 75 dug in there yesterday morning. Might be gone, might not be."',
        effects: [
          { op: "mod_all_constitution", delta: 3 },
          { op: "add_salvage", amount: 2 },
        ],
      },
      {
        ...
        role: "gunner",
        dialogueLine:
          "We've been following a map that's two days old. What does the ground actually look like?",
        outcomeText:
          "The other crew's gunner stands up from somewhere behind the tank and joins the conversation. Two gunners talking about terrain is worth a battalion briefing.",
        npcReply:
          "\"Soft ground on the left flank. You'll bog if you go off road. The right has better drainage but there's a ditch that'll swallow a track if you don't see it.\"",
        effects: [{ op: "mod_all_constitution", delta: 5 }],
      },
      {
        id: "share_rations",
        ...
        outcomeText:
          "They do. They didn't say they did but they do. The rations disappear in about three minutes and the other commander shakes your loader's hand in a way that means more than rations.",
        npcReply:
          "\"We'll remember that. If you're ever east of Aachen ask for Bravo-2. That's us.\"",
        effects: [
          { op: "mod_resource", key: "foodDays", delta: -1 },
          { op: "mod_all_constitution", delta: 6 },
          { op: "mod_constitution", role: "loader", delta: 5 },
  ...
  npc_medic_check: {
    ...
    kind: "npc_conversation",
    atmosphere:
      "Between missions. A medic doing the rounds. The kind of professional optimism that means he's seen the alternative.",
    narrative:
      "A field medic works his way down the column with a kit bag and the careful eyes of someone whose job is to see what people are hiding. He stops at your tank. He looks at the crew the way doctors look at patients — which is to say, briefly and accurately.",
    preChoiceNpc: {
      speaker: "Medic Pvt. Torres",
      line: "Everyone functional? Anyone hiding something I'm going to hear about later?",
    },
    choices: [
      {
        id: "let_him_check",
        ...
        outcomeText:
          "He finds three things. None of them are emergencies. All of them are better addressed now than later. He patches what he can and makes notes on the rest.",
        npcReply:
          "\"The loader's got shrapnel in his left hand that's going to be a problem in about a week. Tell him.\"",
        effects: [
          { op: "mod_all_constitution", delta: 5 },
          { op: "mod_resource", key: "medkits", delta: -1 },
        ],
      },
      {
        ...
        flavorOnly: true,
        outcomeText:
          "He looks at the crew with the neutral expression of a man who has heard \"we're fine\" before. He moves on. Maybe you're right. Maybe you'll find out.",
        effects: [],
      },
      {
        id: "ask_crewman",
        ...
        outcomeText:
          "Torres sits the loader down and spends five minutes on him. The diagnosis is fatigue compounded by a mild concussion and the specific damage of not having acknowledged it. He prescribes rest, which is the one thing available.",
        npcReply:
          "\"He's functional. He'll stay functional if you watch him. Let him sleep when you can.\"",
        effects: [
          { op: "mod_constitution", role: "loader", delta: 8 },
          { op: "mod_all_constitution", delta: 3 },
        ],
  ...
  npc_war_correspondent: {
    ...
    kind: "npc_conversation",
    atmosphere:
      "After an engagement. The smoke hasn't cleared and there's a man in a correspondent's jacket with a notebook. War has a press corps.",
    narrative:
      "A journalist with a notebook and the practiced manner of someone who has asked the same question in many dangerous places catches up to the tank after the last contact. He has a press badge and the specific kind of energy of a man who is both brave and unqualified to assess risk.",
    preChoiceNpc: {
      speaker: "Correspondent",
      line: "Tank commander — what happened back there? The readers want to know what armor combat looks like up close.",
    },
    choices: [
      {
        id: "honest_story",
        ...
        role: "commander",
        dialogueLine:
          "It was loud and fast and I don't know if we did the right thing or just the possible thing. That's usually what it is.",
        outcomeText:
          "He writes it down. Not what he was hoping for, maybe. But he writes it down. It's the kind of quote that gets cut by editors and remembered by the man who heard it.",
        npcReply:
          "\"That's the most honest thing anyone's told me in six months. I'll see what I can do with it.\"",
        effects: [
          { op: "mod_constitution", role: "commander", delta: 6 },
          {
            op: "journal",
            text: "Talked to a correspondent after the engagement. Told him what it actually was.",
            kind: "moment",
          },
        ],
      },
      {
        ...
        role: "commander",
        dialogueLine:
          "We engaged and neutralized a threat to the advance. The crew performed well. That's the story.",
        flavorOnly: true,
        outcomeText:
          "He writes it all down and thanks you. That version will go home in a newspaper. It is not wrong. It is not the whole story. Both of those things are true.",
        effects: [],
      },
      {
        id: "refuse",
        ...
        outcomeText:
          "He closes the notebook. Some crews don't talk. He understands. He moves on to the next tank and asks the same question and gets a different answer.",
        npcReply:
          "He nods and moves off without complaint. A journalist who understands no is rarer than you'd think.",
  ...
  npc_prisoner_moment: {
    ...
    kind: "npc_conversation",
    atmosphere:
      "After infantry contact. There's a man standing in a field with his hands raised and the specific expression of someone who has made the most important decision of his life.",
    narrative:
      "He came out of a ditch with his hands already up — no weapons visible, uniform muddy, young. He is a German soldier. He is also a person. Both of those things are true at the same time and that's what makes this complicated.",
    ...
    choices: [
      {
        ...
        flavorOnly: true,
        outcomeText:
          "He understands the gesture. He goes. Behind him the field is empty and quiet in the particular way that happens after someone isn't there anymore.",
        effects: [],
      },
      {
        id: "gesture_question",
        ...
        outcomeText:
          "He shows three fingers, then points east, then shakes his head. Three. Somewhere east. Gone or not, he doesn't know. The gunner marks it and waves him back.",
      ...
      },
      {
        ...
        outcomeText:
          "He takes it with both hands. Drinks. Hands it back. The loader nods. He nods back. That's the whole exchange. It has no strategic value whatsoever.",
        npcReply:
          "He walks toward the rear in a straight line, hands still partially raised. The loader watches until he's small.",
        effects: [
          { op: "mod_resource", key: "waterCanteens", delta: -1 },
          { op: "mod_all_constitution", delta: 5 },
          { op: "mod_constitution", role: "loader", delta: 6 },
  ...
  npc_padre_field: {
    ...
    kind: "npc_conversation",
    atmosphere:
      "R&R. A different chaplain than you've seen before — older, walking the line with a quiet that's earned, not performed.",
    narrative:
      "An army chaplain makes his way along the vehicle line, stopping briefly at each tank. He's not performing faith at people — he's just moving through, available. When he reaches yours he looks at the crew the way a person looks at people, which is already different from how most of this works.",
    preChoiceNpc: {
      speaker: "Chaplain",
      line: "Don't get up. I'm just walking. Is there anything you need?",
    },
    choices: [
      {
        id: "talk_briefly",
        ...
        flavorOnly: true,
        outcomeText:
          "He sits on the hull for ten minutes. He mostly listens. He says something at the end that isn't a verse or a platitude, just an observation. It stays with you.",
        effects: [],
      },
      {
        id: "ask_personal",
        ...
        outcomeText:
          "He's quiet for long enough that you think he's going to give you an answer. Instead he says he doesn't, that he's been asking the same question since North Africa, and that he finds asking it useful even without the answer.",
      ...
      },
      {
        ...
        outcomeText:
          "He sits on the hull for twenty minutes. At some point the crew realizes nobody's talking and nobody minds. He leaves when he's ready. The tank feels slightly larger afterward.",
        npcReply:
          '"Thank you for the company." He means the crew. He means the silence. He means all of it.',
        effects: [
          { op: "mod_all_constitution", delta: 8 },
          { op: "mod_constitution", role: "loader", delta: 5 },
        ],
  ...
  npc_old_farmer: {
    ...
    kind: "npc_conversation",
    atmosphere:
      "Farmland that was working before the war and will be working after. The man standing at the edge of his field has outlasted armies before.",
    narrative:
      "An older farmer watches the column pass from the edge of a furrowed field. He's not afraid. He's seen enough of this to have made his peace with what armies do to land and to men, and he's still standing in his field which means something.",
    preChoiceNpc: {
      speaker: "The farmer",
      line: "He watches. He doesn't wave. He watches the way people watch weather.",
    },
    choices: [
      {
        id: "nod_pass",
        ...
        flavorOnly: true,
        outcomeText:
          "He nods back. One acknowledging glance exchanged between a man going somewhere and a man staying put. That's the whole conversation and it says what it needs to.",
        effects: [],
      },
      {
        id: "stop_acknowledge",
        ...
        outcomeText:
          "He's quiet for a moment. Then he says something in a dialect that doesn't translate exactly. The driver thinks it means 'don't break the fence posts.' The commander thinks it might mean something else. Either way it's not hostile.",
        npcReply:
          "He gestures at the field — the churned mud and tank tracks — and shrugs. He's seen worse. He'll fix it.",
        effects: [
          { op: "mod_all_constitution", delta: 4 },
          {
            op: "journal",
            text: "An old farmer at the edge of a field. Still there.",
            kind: "moment",
          },
        ],
      },
      {
        ...
        outcomeText:
          "He accepts it. He doesn't move toward the tank — he waits, and the driver stretches out a little further to bridge the gap. It's a good cigarette. He looks at it like it's a good cigarette.",
        npcReply:
          "He lights it with a match from his jacket, takes one draw, and goes back to watching the column. He doesn't wave. He doesn't need to.",
        effects: [
          { op: "mod_constitution", role: "driver", delta: 6 },
          { op: "mod_all_constitution", delta: 3 },
        ],
  ...
  legendary_sergeant_york_moment: {
    ...
    kind: "npc_conversation",
    atmosphere:
      "A lull in the column. A man in a different cut of uniform is studying a map like it owes him money.",
    narrative:
    ...
    stakes: "critical",
    stakesNote:
      "A named soldier on the road — what you say and what you give may matter more than the map.",
    preChoiceNpc: {
    ...
    choices: [
      {
        ...
        role: "commander",
        dialogueLine:
          "East's hot until 1600. Crossroads at grid 512 — hold there, don't push past without arty.",
        outcomeText:
          "He listens like a man who files everything. When you're done he folds the map and nods once.",
        ...
        effects: [
          ...
          {
            op: "journal",
            text: "A sergeant the papers will write about passed through. You gave him the truth.",
            kind: "moment",
          },
        ],
      },
      {
        ...
        outcomeText:
          "He takes the tin without ceremony. Some debts on the road never get repaid in kind.",
      ...
      },
      {
        ...
        flavorOnly: true,
        outcomeText:
          "He steps back from the treads. The column moves. You don't look back long enough to see if he finds his way.",
        effects: [],
      },
    ],
  },
