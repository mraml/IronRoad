...
export const SCAR_NAME_POOLS: Record<
  "shrapnel" | "hearing" | "vision" | "burn" | "crush",
  string[]
> = {
  shrapnel: [
    "Bent trigger finger",
...
export const ROLES_ORDER: Role[] = ["commander", "gunner", "driver", "asst_driver", "loader"];
...
export function generateCrew(seed: string, start: number): { crew: CrewMember[]; next: number } {
  ...
  const { picked: nicknames, nextCounter: c1 } = pickManyUnique(
    seed,
    c,
    NICKNAMES,
    ROLES_ORDER.length,
